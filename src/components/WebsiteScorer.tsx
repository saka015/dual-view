      ...
      {isAnalyzing && (
        <div className="text-center py-16">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
            We're checking responsiveness, design aesthetics, colors,
            typography, and more.
          </p>
        </div>
      )}
      ...
      {scores.overall !== null && (
        <div className="p-6">
          <div className="text-center p-6 bg-gray-50 dark:bg-gray-700 rounded-lg mb-6">
            ...
            <div className="mt-2">
              {scores.overall !== null && renderScoreBadge(scores.overall)}
            </div>
          ...
          >
            ...
            <TabsContent value="responsive" className="space-y-6">
                ...
                {responsiveBreakdown && (
                  <div className="space-y-4">
                    {renderFactorScore(
                      ...
                      responsiveBreakdown.viewportMeta,
                      10
                    )}
                    {renderFactorScore(
                      "Media Queries Implementation",
                      responsiveBreakdown.mediaQueries,
                      20
                    )}
                    {renderFactorScore(
                      "Flexible Images & Media",
                      responsiveBreakdown.flexibleImages,
                      15
                    )}
                    {renderFactorScore(
                      "Touch Target Sizes",
                      responsiveBreakdown.touchTargets,
                      10
                    )}
                    {renderFactorScore(
                      "Font Scaling",
                      responsiveBreakdown.fontScaling,
                      10
                    )}
                    {renderFactorScore(
                      "No Horizontal Scrolling",
                      responsiveBreakdown.noHorizontalScroll,
                      15
                    )}
                    {renderFactorScore(
                      "Mobile Load Time",
                      responsiveBreakdown.loadTimeMobile,
                      20
                    )}
                  </div>
                )}
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-gray-700 dark:text-gray-300">
                  ...
                  <li>
                    Implement a mobile-first approach with progressive
                    enhancement
                  </li>
            ...
            <TabsContent value="design" className="space-y-6">
              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                ...
                {aestheticsBreakdown && (
                  <div className="space-y-4">
                    {renderFactorScore(
                      "Color Harmony",
                      aestheticsBreakdown.colorHarmony,
                      15
                    )}
                    {renderFactorScore(
                      "Typography",
                      aestheticsBreakdown.typography,
                      15
                    )}
                    {renderFactorScore(
                      "Visual Hierarchy",
                      aestheticsBreakdown.visualHierarchy,
                      20
                    )}
                    {renderFactorScore(
                      "Design Consistency",
                      aestheticsBreakdown.consistency,
                      15
                    )}
                    {renderFactorScore(
                      "White Space Usage",
                      aestheticsBreakdown.whiteSpace,
                      10
                    )}
                    {renderFactorScore(
                      "Imagery Quality",
                      aestheticsBreakdown.imageryQuality,
                      15
                    )}
                    {renderFactorScore(
                      "Animations & Transitions",
                      aestheticsBreakdown.animations,
                      10
                    )}
                  </div>
                )}
              ...
              <div className="p-4 bg-purple-50 dark:bg-purple-900/30 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-gray-700 dark:text-gray-300">
                  <li>
                    Use a consistent color scheme with no more than 5 colors
                  </li>
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-800 dark:text-gray-200 max-w-[200px] truncate">
                        {url}
                      </span>
                    </div>
                    <div className="flex justify-between">
