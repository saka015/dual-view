          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto px-4">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:bg-white/15 transition-all">
              ...
              <p className="text-gray-300 mb-4">
                Analyze and score any website based on responsiveness and design
                aesthetics.
              </p>
              <Button
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:bg-white/15 transition-all">
              ...
              <p className="text-gray-300 mb-4">
                Compare two websites side by side to analyze differences and
                similarities.
              </p>
              <Button
                onClick={() => {
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:bg-white/15 transition-all">
              ...
              <p className="text-gray-300 mb-4">
                Get detailed insights about website design, colors, typography,
                and more.
              </p>
              <Button
